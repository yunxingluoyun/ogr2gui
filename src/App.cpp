...
{
    QObject::connect( mnuQuit, &QAction::triggered, this, &App::close);

    QObject::connect( mnuOgrHelp, &QAction::triggered, this, &App::evtMnuOgrHelp );

    QObject::connect( mnuGuiHelp, &QAction::triggered, this, &App::evtMnuGuiHelp );

    QObject::connect( mnuAbout, &QAction::triggered, this, &App::evtMnuAbout );


    QObject::connect( radSourceFile, &QRadioButton::toggled, this,&App::evtRadSourceFile);

    QObject::connect( radSourceFolder, &QRadioButton::toggled, this, &App::evtRadSourceFolder);

    QObject::connect( radSourceDatabase, &QRadioButton::toggled, this, &App::evtRadSourceDatabase);
    ...
    QObject::connect( radTargetFile, &QRadioButton::toggled, this, &App::evtRadTargetFile);

    QObject::connect( radTargetFolder, &QRadioButton::toggled, this, &App::evtRadTargetFolder);

    QObject::connect( radTargetDatabase, &QRadioButton::toggled, this, &App::evtRadTargetDatabase);
    ...
    QObject::connect( radTargetOverwrite, &QRadioButton::toggled, this, &App::evtRadTargetOverwrite);

    QObject::connect( radTargetAppend, &QRadioButton::toggled, this, &App::evtRadTargetAppend );

    QObject::connect( radTargetUpdate, &QRadioButton::toggled, this, &App::evtRadTargetUpdate);


    QObject::connect( btnExecute, QOverload<bool>::of(&QPushButton::clicked), this, &App::evtBtnExecute );

    QObject::connect( btnQuit, QOverload<bool>::of(&QPushButton::clicked), this, &App::evtBtnQuit);
...
{
    QDesktopServices::openUrl( QUrl( tr( "https://gdal.org/programs/ogr2ogr.html#ogr2ogr" ) ) );
}
...
int main( int argc, char **argv )
{
    ...
    QString strTranslatorFile = QApplication::applicationDirPath()+"/ogr2gui_zh.qm";
    if (translator.load(strTranslatorFile))
    {
